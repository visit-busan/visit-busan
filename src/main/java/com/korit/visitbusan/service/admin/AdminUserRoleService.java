...
public class AdminUserRoleService {
    ...
    public Map<String, Object> getUser(String name) {
        ...
        user.put("UserMst", adminUserRoleRepository.findUserByName(name));
        return user;
    }

    public Map<String, Object> getUserAndUserRoles(int userId) {
        Map<String, Object> user = new HashMap<>();
    ...
    public List<RoleMst> getRoleName() {
        return adminUserRoleRepository.findAllRoleName();
    }
